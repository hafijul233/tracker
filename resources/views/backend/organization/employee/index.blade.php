...
@section('content')
                ...
                <div class="card card-default">
                    @if(!empty($employees))
                                ...
                                <table class="table table-hover mb-0" id="employee-table">
                                    ...
                                    @forelse($employees as $index => $employee)
                                        <tr @if($employee->deleted_at != null) class="table-danger" @endif>
                                            ...
                                            <td class="text-center">{{ $employee->created_at->format(config('app.datetime')) ?? '' }}</td>
                        ...
                        <div class="card-footer bg-transparent pb-0">
                            {!! \Modules\Core\Supports\CHTML::pagination($employees) !!}
                        </div>
                    @else
    ...
    <!-- /.container-fluid -->
    {!! \Modules\Core\Supports\CHTML::confirmModal('Employee', ['export', 'delete', 'restore']) !!}
@endsection
