...
@section('content')
                ...
                <div class="card card-default">
                    @if(!empty($branchs))
                                ...
                                <table class="table table-hover mb-0" id="branch-table">
                                    ...
                                    @forelse($branchs as $index => $branch)
                                        <tr @if($branch->deleted_at != null) class="table-danger" @endif>
                                            ...
                                            <td class="text-center">{{ $branch->created_at->format(config('app.datetime')) ?? '' }}</td>
                        ...
                        <div class="card-footer bg-transparent pb-0">
                            {!! \Modules\Core\Supports\CHTML::pagination($branchs) !!}
                        </div>
                    @else
    ...
    <!-- /.container-fluid -->
    {!! \Modules\Core\Supports\CHTML::confirmModal('Branch', ['export', 'delete', 'restore']) !!}
@endsection
