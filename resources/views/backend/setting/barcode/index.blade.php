...
@section('content')
                ...
                <div class="card card-default">
                    @if(!empty($barcodes))
                        <div class="card-body p-0">
                            ...
                            ['placeholder' => 'Search Barcode Name etc.',
                                ...
                                <table class="table table-hover mb-0" id="barcode-table">
                                    ...
                                    @forelse($barcodes as $index => $barcode)
                                        <tr @if($barcode->deleted_at != null) class="table-danger" @endif>
                                            ...
                                            <td class="text-center">{{ $barcode->created_at->format(config('app.datetime')) ?? '' }}</td>
                        ...
                        <div class="card-footer bg-transparent pb-0">
                            {!! \Modules\Core\Supports\CHTML::pagination($barcodes) !!}
                        </div>
                    @else
    ...
    <!-- /.container-fluid -->
    {!! \Modules\Core\Supports\CHTML::confirmModal('Barcode', ['export', 'delete', 'restore']) !!}
@endsection
